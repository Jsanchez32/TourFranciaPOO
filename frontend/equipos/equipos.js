...
async function mostrarDatos(){
    ...
    const equipos = await mostrar();
    equipos.forEach((ciclista)=>{
        const {nombre,pais,_id}=ciclista
...
async function mostrarOne(e){
    ...
    const datos = await selectOne(ciclistaId);
        ...
        const paisUpdate = document.querySelector('#paisUpdate');
        const id = document.querySelector('#idUpdate');

        nombreUpdate.value=datos.nombre;
        paisUpdate.value=datos.pais;
        id.value=ciclistaId;
}
